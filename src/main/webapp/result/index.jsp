			...
			<div class="fh5co-cover text-center" data-stellar-background-ratio="0.5" style="background-image: url(images/cover_bg_1.jpg);">
				<div class="desc animate-box">
					...
					<a class="btn btn-primary btn-lg btn-learn" href="javascript:message()">个人信息</a>
                     ...
                     <a class="btn btn-primary btn-lg btn-learn" href="#" title="待公布">获奖结果</a>
                      <a class="btn btn-primary btn-lg btn-video" href="${APP_PATH }/baoming/index.jsp" title="待公布">报名后续</a>
                     </p>
				</div>
			</div>
		</div>
